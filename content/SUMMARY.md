...
* [机器学习](perface/machine-learning-perface/machine-learning-perface.md)
  ...
  * [不同的机器学习算法对相同数据预测效果不同](perface/machine-learning-perface/machine-learning-perface.md#不同的机器学习算法对相同数据预测效果不同)
...
* [线性代数](mathematics/linear-algebra/linear-algebra.md)
  ...
  * [奇异值分解](mathematics/linear-algebra/singular-value-decomposition.md)
* [概率与信息论](mathematics/statistics-and-information-theory/statistics-and-information-theory.md)
  ...
  * [概率图模型-结构化概率模型](mathematics/statistics-and-information-theory/probability-graphical-model.md)
