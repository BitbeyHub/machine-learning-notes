...
* [数值计算与优化](content/mathematics/numerical-calculation-and-optimization/numerical-calculation-and-optimization.md)
    * [最小二乘法](content/mathematics/numerical-calculation-and-optimization/least-square-method.md)
...
* [梯度下降算法](content/mathematics/gradient-descent-algorithm/gradient-descent-algorithm.md)
    ...
    - [AdaGrad](content/mathematics/gradient-descent-algorithm/adagrad.md)
    - [RMSprop](content/mathematics/gradient-descent-algorithm/rmsprop.md)
    - [Adadelta](content/mathematics/gradient-descent-algorithm/adadelta.md)
    - [Adam](content/mathematics/gradient-descent-algorithm/adam.md)
    - [Nadam](content/mathematics/gradient-descent-algorithm/nadam.md)
    - [AMSGrad](content/mathematics/gradient-descent-algorithm/amsgrad.md)
    - [AdasMax](content/mathematics/gradient-descent-algorithm/adamax.md)
...
* [python](content/coding/python/python.md)
    ...
    * [python语法](content/coding/python/grammar/grammar.md)
        ...
        * [数据结构](content/coding/python/grammar/data-structure/data-structure.md)
        * [过程控制](content/coding/python/grammar/process-control/process-control.md)
        * [函数](content/coding/python/grammar/function/function.md)
        * [类和对象](content/coding/python/grammar/class/class.md)
        * [文件操作](content/coding/python/grammar/file/file.md)
        * [正则表达式](content/coding/python/grammar/regular-expression/regular-expression.md)
    * [python库](content/coding/python/library/library.md)
        * [numpy](content/coding/python/library/numpy.md)
        * [pandas](content/coding/python/library/pandas.md)
        * [scipy](content/coding/python/library/scipy.md)
        * [matplotlib](content/coding/python/library/matplotlib.md)
...
* [数据结构与算法](content/coding/data-structures-and-algorithms/data-structures-and-algorithms.md)
    ...
    * [算法思想](content/coding/data-structures-and-algorithms/algorithms/algorithms.md)
      * [排序](content/coding/data-structures-and-algorithms/algorithms/sort/sort.md)
        * [堆排序](content/coding/data-structures-and-algorithms/algorithms/sort/heap-sort.md)
        * [归并排序](content/coding/data-structures-and-algorithms/algorithms/sort/merge-sort.md)
        * [快速排序](content/coding/data-structures-and-algorithms/algorithms/sort/quick-sort.md)
    ...
    * [剑指offer](content/coding/data-structures-and-algorithms/jianzhi-offer/jianzhi-offer.md)
      ...
      - [其他](content/coding/data-structures-and-algorithms/jianzhi-offer/others/others.md)
...
* [集成学习](content/machine-learning/ensemble-learning/ensemble-learning.md)
    * Bagging
        * [随机森林](content/machine-learning/ensemble-learning/random-forest/random-forest.md)
    * Boosting
        * [AdaBoost](content/machine-learning/ensemble-learning/adaboost/AdaBoost.md)
        * GradientBoosting
            * [GBDT](content/machine-learning/ensemble-learning/gbdt/GBDT.md)
...
# [深度学习](content/deep-learning/deep-learning.md)
...
* [知识点](content/deep-learning/tips/tips.md)
  - [Batch Normalization](content/deep-learning/tips/batch-normalization/batch-normalization.md)
...
* [GRU门控循环单元](content/deep-learning/gated-recurrent-unit/gated-recurrent-unit.md)
* [GNN图神经网络](content/deep-learning/graph-neural-networks/graph-neural-networks.md)
  ...
  * [GCN图卷积网络](content/deep-learning/graph-neural-networks/graph-convolutional-networks/graph-convolutional-networks.md)
    * [GCN图卷积网络初步理解](content/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-preliminary-understand.md)
    * [GCN图卷积网络的numpy简单实现](content/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-numpy-fulfillment.md)
    * [GCN图卷积网络本质理解](content/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-essential-understand.md)
    * [GCN图卷积网络全面理解](content/deep-learning/graph-neural-networks/graph-convolutional-networks/gcn-comprehensive-understand.md)
...
* [神经网络架构搜索](content/deep-learning/neural-architecture-search/neural-architecture-search.md)
  - [Weight-Agnostic-Neural-Networks Google2019](content/deep-learning/neural-architecture-search/Weight-Agnostic-Neural-Networks.md)
...
* [Self-Attention和Transformer](content/natural-language-processing/self-attention-and-transformer/self-attention-and-transformer.md)
...
* [进阶知识](content/recommender-systems/advanced-knowledge/advanced-knowledge.md)
  * [机器学习](content/recommender-systems/advanced-knowledge/machine-learning/machine-learning.md)
  ...
  * [图卷积网络](content/recommender-systems/advanced-knowledge/graph-convolutional-network/graph-convolutional-network.md)
    * [Graph Convolutional Neural Networks for Web-Scale Recommender Systems KDD2018](content/recommender-systems/advanced-knowledge/graph-convolutional-network/Graph-Convolutional-Neural-Networks-for-Web-Scale-Recommender-Systems.md)
