...
* [概率与信息论](content/mathematics/statistics-and-information-theory/statistics-and-information-theory.md)
    ...
    * [偏差和方差](content/mathematics/statistics-and-information-theory/bias-and-variance.md)
    ...
    * [概率图模型-结构化概率模型](content/mathematics/statistics-and-information-theory/probability-graphical-model.md)
...
* [数值计算与优化](content/mathematics/numerical-calculation-and-optimization/numerical-calculation-and-optimization.md)
    ...
    * [不等式约束的KKT条件](content/mathematics/numerical-calculation-and-optimization/karush-kuhn-tucker-conditions.md)
...
* [集成学习](content/machine-learning/ensemble-learning/ensemble-learning.md)
    * [随机森林[Bagging]](content/machine-learning/ensemble-learning/random-forest[Bagging].md)
    * [AdaBoost[Boosting]](content/machine-learning/ensemble-learning/AdaBoost[Boosting].md)
    * [GBDT[GradientBoosting]](content/machine-learning/ensemble-learning/GBDT[GradientBoosting].md)
    * [XgBoost[GradientBoosting]](content/machine-learning/ensemble-learning/XgBoost[GradientBoosting].md)
